...
const MusicPlayer = () => {
  return (
    <div className='flex items-center justify-between w-full  h-full  bg-[#121212] py-4 px-2 flex-row max-1440:mt-2 max-1280:mt-2 max-1170:mt-2 exact-1024:mt-3 max-1024:mt-3'>
        <div className='flex flex-row gap-x-3 w-full max-1024:items-center'>
            <img src={assets.img1} alt="" width={50} height={40} className='max-1280:w-[40px] max-1280:h-[40px] max-1024:w-[30px] max-1024:h-[30px] max-1024:rounded-full max-768:w-[28px] max-768:h-[28px]'/>
            <div className='text-white flex items-start justify-center flex-col gap-y-2 max-1280:gap-0.5 max-1024:gap-0'>
        ...
        <div className='flex flex-col items-center w-full gap-2 max-1024:mr-8 max-1024:gap-1 max-1024:mt-2'>
            ...
            <div className='text-white flex flex-row items-center justify-center gap-4 text-sm font-neutral'>
                ...
                <div className='w-[50vw] h-[3px] max-w-[400px] bg-gray-300 rounded-full cursor-pointer max-1170:max-w-[300px]  max-1024:max-w-[300px]'>
                    <hr className='h-1 border-none w-0 bg-green-800 rounded-full'/>
                </div>
                <p className='max-1024:text-[12px]'>3:20</p>
            </div>
        </div>
        <div className='w-full flex flex-row items-center justify-end gap-3 opacity-70  max-768:hidden'>
        ...
        <div className='hidden max-768:flex'><img src={assets.plus_icon} alt="" width={40} height={40} /></div>
    </div>
  )
}
